...
export default function PortfolioPage() {
  ...
  /**
   * ⚡ BOLT OPTIMIZATION: Stable handler references to prevent child re-renders.
   * Impact: Ensures memoized ProjectCard components don't re-render on parent state changes.
   */
