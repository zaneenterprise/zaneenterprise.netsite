...
/**
 * Portfolio page component with memoized handlers to prevent unnecessary
 * re-renders of the ProjectCard list when interacting with the lightbox.
 */
export default function PortfolioPage() {
  ...
  // Memoized handlers ensure stable references passed to child components
