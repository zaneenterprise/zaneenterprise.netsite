...
/**
 * Enhanced ImageLightbox with image preloading and stable event handlers.
 * Ensures smooth transitions and consistent performance.
 */
export function ImageLightbox({
    ...
    useEffect(() => {
        ...
        const preloadImage = (url: string) => {
            const img = new Image()
            img.src = getBunnyCDNUrl(url, LIGHTBOX_IMAGE_OPTIONS)
        }

        preloadImage(projectImages[nextIndex].url)
        preloadImage(projectImages[prevIndex].url)
