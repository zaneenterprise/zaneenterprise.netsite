...
export function ImageLightbox({
    ...
    useEffect(() => {
        ...
        preloadNext.src = getBunnyCDNUrl(projectImages[nextIndex].url, LIGHTBOX_IMAGE_OPTIONS)

        const preloadPrev = new Image()
        preloadPrev.src = getBunnyCDNUrl(projectImages[prevIndex].url, LIGHTBOX_IMAGE_OPTIONS)
