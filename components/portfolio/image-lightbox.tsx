...
const LIGHTBOX_IMAGE_OPTIONS: BunnyImageOptions = { width: 2048, quality: 90, auto_optimize: 'low', sharpen: true } as const
...
export function ImageLightbox({
    ...
    useEffect(() => {
        ...
        const imagesToPreload = [projectImages[nextIndex].url, projectImages[prevIndex].url]
