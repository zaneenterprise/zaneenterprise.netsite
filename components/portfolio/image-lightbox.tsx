...
export function ImageLightbox({
    ...
    useEffect(() => {
        ...
        if (projectImages.length > 1) {
            ...
            nextImg.src = getBunnyCDNUrl(projectImages[nextIndex].url, LIGHTBOX_IMAGE_OPTIONS)

            const prevImg = new Image()
            prevImg.src = getBunnyCDNUrl(projectImages[prevIndex].url, LIGHTBOX_IMAGE_OPTIONS)
        }
