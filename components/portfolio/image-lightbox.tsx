...
export function ImageLightbox({
    ...
    // Programmatically preload adjacent images for instant transitions
    useEffect(() => {
        ...
        const preloadImage = (index: number) => {
            const url = getBunnyCDNUrl(projectImages[index]?.url || "/placeholder.svg", LIGHTBOX_IMAGE_OPTIONS)
            const img = new Image()
            img.src = url
        }
