...
export function ImageLightbox({
    ...
    // Handlers are memoized to keep event listeners stable
    ...
    /**
     * Programmatic preloading of adjacent images to ensure instantaneous
     * transitions during lightbox navigation.
     */
    useEffect(() => {
