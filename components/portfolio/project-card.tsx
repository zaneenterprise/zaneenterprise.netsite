...
/**
 * ProjectCard component display a single project.
 * Memoized to prevent re-renders when other items in the portfolio grid update
 * or when the parent's lightbox state changes.
 */
