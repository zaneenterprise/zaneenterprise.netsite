...
/**
 * Optimized ProjectCard component that uses React.memo to prevent unnecessary re-renders.
 * Parent re-renders (like opening a lightbox) won't trigger re-renders of the entire grid.
 */
